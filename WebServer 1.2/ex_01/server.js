...
let get_station_data = (parameters) => {
    ...
    fs.readFile("./data/Stationen.json", "utf8", (err, data) => {
    if (err) {
    console.error(err)
    return
    }
...
let get_data_2017 = (parameters) => {
    ...
    fs.readFile("./data/Feinstaub_2017.json", "utf8", (err, data) => {
    if (err) {
    console.error(err)
    return
    }
...
let get_data_2018 = (parameters) => {
    ...
    fs.readFile("./data/Feinstaub_2018.json", "utf8", (err, data) => {
    if (err) {
    console.error(err)
    return
    }
...
let get_data_2019 = (parameters) => {
    ...
    fs.readFile("./data/Feinstaub_2019.json", "utf8", (err, data) => {
    if (err) {
    console.error(err)
    return
    }
